...
const Explanation = () => {
  return (
    ...
    <div>
      ...
      <CardBody className="bg-dark-2 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl border  ">
        <CardItem
          translateZ="50"
        ...
        <div className="flex justify-between items-center mt-20">
          <Link
            ...
            href="/team"
            className="px-4 py-2 rounded-xl text-base font-bold text-white"
          >
            Team →
          </Link>
          <Link
