    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className='flex w-full max-w-[520px] flex-col gap-6 border-none bg-dark-1 px-6 py-9 text-white'>
        <div className='flex flex-col gap-6'>
          ...
          {children}
          <Button className='bg-green-500 hover:bg-green-600 focus-visible:ring-0 focus-visible:ring-offset-0' onClick={handleClick}>
            {buttonIcon &&(<Image src={buttonIcon} alt={"buttonicon"} width={30} height={30}/>)}
